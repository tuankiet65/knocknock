...
Register8::Register8() {}
uint8_t Register8::read() const { return value_; }
void Register8::write(uint8_t value) { value_ = value; }

Register16::Register16() {}
uint16_t Register16::read() const { return value_; }
void Register16::write(uint16_t value) { value_ = value; }
...
uint8_t Immediate8::read() const { return value_; }
...
uint16_t Immediate16::read() const { return value_; }
...
Memory8::Memory8(memory::Memory *mem, memory::MemoryAddr addr)
    : mem_(mem), addr_(addr) {}
uint8_t Memory8::read() const { return mem_->read(addr_); }
void Memory8::write(uint8_t value) { mem_->write(addr_, value); }

Memory16::Memory16(memory::Memory *mem, memory::MemoryAddr addr)
    : mem_(mem), addr_(addr) {}
uint16_t Memory16::read() const { return mem_->read16(addr_); }
void Memory16::write(uint16_t value) { mem_->write16(addr_, value); }
